  ...
  describe("Passages", () => {
    describe("General", () => {
      ...
      it("should parse both tags and metadata", () => {
        const story: Story = { passages: [] };
        const text = ':: Passage 1 [tag-1] {"position":"600,400"}\nP1 contents';
      ...
      describe("Passages", () => {
        describe("General", () => {
          it("should error on passages with metadata before tags", () => {
            ...
            expect(result.message).to.eql("Tags need to come before metadata");
          ...
          it("should error on passages with unclosed tags", () => {
            ...
            expect(result.message).to.eql("Tags aren't formatted correctly");
          ...
          it("should error on passages with unclosed metadata", () => {
            ...
            expect(result.message).to.eql("Metadata isn't formatted correctly");
            expect(result.start).to.eql(13);
          ...
          it("should error on passages with badly-formatted metadata", () => {
            ...
            expect(result.message).to.include("Couldn't parse metadata:");
            expect(result.start).to.eql(13);
