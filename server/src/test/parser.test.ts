  ...
  describe("Passages", () => {
    describe("General", () => {
      ...
      it("should call back with the passage's name", () => {
        ...
        expect(callbacks.passages[0].name.contents).to.equal("Passage 1");
      });
      ...
      it("should call back with the passage's tag names and locations captured", () => {
        ...
        expect(result).to.eql([
          {
            contents: "tag-1",
            location: Location.create("fake-uri", Range.create(0, 14, 0, 19)),
          },
          {
            contents: "tag_2",
            location: Location.create("fake-uri", Range.create(0, 21, 0, 26)),
          },
        ]);
      });
      ...
      it("should ignore repeated tags", () => {
        ...
        uut.parse(doc, callbacks, uut.ParseLevel.Full);
        const result = callbacks.passages[0].tags?.map((x) => x.contents);
      ...
      it("should capture passage tags with escaped metacharacters", () => {
        ...
        expect(result).to.eql([
          ...
          {
            contents: "[tag_2]",
            location: Location.create("fake-uri", Range.create(0, 20, 0, 29)),
          },
        ]);
      });
      ...
      it("should call back with the passage's metadata captured", () => {
        ...
        expect(result.metadata).to.eql({
          raw: {
            ...
            location: Location.create("fake-uri", Range.create(0, 13, 0, 53)),
          },
          position: "600,400",
          size: "100,200",
        });
      ...
      it("should call back with both the passage's tags and metadata", () => {
        ...
        expect(result.metadata).to.eql({
          raw: {
            ...
            location: Location.create("fake-uri", Range.create(0, 21, 0, 43)),
          },
          position: "600,400",
        });
      });
    ...
    describe("Special Passages", () => {
      ...
      it("should call back on StoryData with the data's range", () => {
        ...
        expect(callbacks.storyDataRange?.end).to.eql(Position.create(3, 1));
      });
      ...
      it("should call back on StoryData with the format version included", () => {
        ...
        expect(callbacks.storyData?.storyFormat?.formatVersion).to.equal(
          "17.2",
        );
      });
    ...
    describe("Passage Text Parsing", () => {
      it("should parse passage text based on the initial story format", () => {
        ...
        expect(receivedContents).to.eql(["I am the passage contents!\n"]);
      });
            ...
            return {
              ...
              parsePassageText: (
                ...
                receivedContents.push(
                  state.currentPassage?.name.contents || "nope!",
                );
              },
            };
          }
    ...
    describe("Links", () => {
      it("should produce no semantic tokens for an empty [[]] link", () => {
        ...
        const storyFormatParsingState = { passageTokens: {} };
      ...
      it("should set semantic tokens for a [[target]] link", () => {
        ...
        uut.findAndParseLinks(passage, 2, state, storyFormatParsingState);
    ...
    describe("Html", () => {
      ...
      it("should replace the HTML style section with blanks in the subsection", () => {
        ...
        const result = uut.findAndParseHtml(passage, header.length, state);
