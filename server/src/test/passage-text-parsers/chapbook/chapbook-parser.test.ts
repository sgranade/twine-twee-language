  ...
  describe("script passages", () => {
    it("should parse engine extension calls in script passages", () => {
      ...
      expect(result).to.eql({
        name: "hi",
        contents: "hi",
        location: Location.create("fake-uri", Range.create(3, 9, 3, 11)),
        kind: OChapbookSymbolKind.CustomInsert,
        match: /hi/,
      });
    });
  ...
  describe("vars section", () => {
    ...
    it("should capture references for a variable name and its property", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "var1.prop",
          location: Location.create("fake-uri", Range.create(2, 6, 2, 10)),
          kind: OChapbookSymbolKind.PropertySet,
        },
      ]);
    });
    ...
    it("should capture a reference for variables used in conditions", () => {
      ...
      expect(result_0).to.eql({
        contents: "var_1",
        location: Location.create("fake-uri", Range.create(2, 8, 2, 13)),
        kind: OChapbookSymbolKind.Variable,
      });
      expect(result_1).to.eql({
        contents: "otherVar",
        location: Location.create("fake-uri", Range.create(2, 17, 2, 25)),
        kind: OChapbookSymbolKind.Variable,
      });
    ...
    it("should capture a reference for a variable's condition that itself contains a variable", () => {
      ...
      expect(result).to.eql({
        contents: "var2",
        location: Location.create("fake-uri", Range.create(2, 7, 2, 11)),
        kind: OChapbookSymbolKind.Variable,
      });
    });
    ...
    it("should capture a reference for a variable's value that itself contains a variable", () => {
      ...
      expect(result).to.eql({
        contents: "var2",
        location: Location.create("fake-uri", Range.create(2, 11, 2, 15)),
        kind: OChapbookSymbolKind.Variable,
      });
    });
    ...
    describe("modifiers", () => {
      describe("basic semantic tokens", () => {
        ...
        it("should set a semantic token for a note modifier", () => {
          ...
          parser?.parsePassageText(passage, header.length, state);
          const [modToken, nbToken, noteToken1, noteToken2] = callbacks.tokens;
      ...
      describe("contents parsing", () => {
        it("should capture a reference for a known modifier", () => {
          ...
          expect(result).to.eql({
            contents: "mock-mod",
            location: Location.create("fake-uri", Range.create(1, 1, 1, 9)),
        ...
        it("should create a variable reference for a first arg that's an expression and contains a variable", () => {
          ...
          expect(result[1]).to.eql({
            contents: "tempy",
            location: Location.create("fake-uri", Range.create(1, 10, 1, 15)),
            kind: OChapbookSymbolKind.Variable,
          });
          expect(result[2]).to.eql({
            contents: "other",
            location: Location.create("fake-uri", Range.create(1, 18, 1, 23)),
            kind: OChapbookSymbolKind.Variable,
          });
          expect(result[3]).to.eql({
            contents: "other.prop",
            location: Location.create("fake-uri", Range.create(1, 24, 1, 28)),
        ...
        it("should create a passage reference for a first arg that's a passage", () => {
          ...
          expect(result).to.eql({
            contents: "arg",
            location: Location.create("fake-uri", Range.create(1, 11, 1, 14)),
        ...
        it("should create variable and property references for a non-string first arg that's a urlOrPassage", () => {
          ...
          expect(result[2]).to.eql({
            contents: "arg.prop",
            location: Location.create("fake-uri", Range.create(1, 15, 1, 19)),
            kind: OChapbookSymbolKind.Property,
          });
        });
        ...
        it("should not capture variables in a javascript modifier", () => {
          ...
          expect(result).to.eql([
            {
              contents: "javascript",
              location: Location.create("fake-uri", Range.create(3, 1, 3, 11)),
              kind: OChapbookSymbolKind.BuiltInModifier,
            },
          ]);
        });
        ...
        it("should set an embedded document for a CSS modifier", () => {
          ...
          expect(result.document.getText()).to.eql("Fake CSS\nMore fake\n");
    ...
    describe("inserts", () => {
      ...
      describe("semantic token order", () => {
        it("should interleave tokens in document order", () => {
          ...
          parser?.parsePassageText(passage, header.length, state);
          const [target1Token, varToken, target2Token] = callbacks.tokens;
      ...
      describe("contents parsing", () => {
        it("should capture a variable reference for a variable insert", () => {
          ...
          expect(result).to.eql([
            {
              contents: "var1",
              location: Location.create("fake-uri", Range.create(2, 21, 2, 25)),
              kind: OChapbookSymbolKind.Variable,
            },
            {
              contents: "var1.prop",
              location: Location.create("fake-uri", Range.create(2, 26, 2, 30)),
              kind: OChapbookSymbolKind.Property,
            },
          ]);
        });
        ...
        it("should capture a reference for a known insert", () => {
          ...
          expect(result).to.eql({
            ...
            location: Location.create("fake-uri", Range.create(1, 9, 1, 20)),
        ...
        it("should capture a variable reference in an insert's first arg", () => {
          ...
          expect(result).to.eql({
            contents: "arg",
            location: Location.create("fake-uri", Range.create(1, 23, 1, 26)),
            kind: OChapbookSymbolKind.Variable,
          });
        });
        ...
        it("should handle multiple inserts in a row on the same line", () => {
          const header = ":: Passage\n";
          const passage = "Insert: {mock insert: 'arg}'} {mock insert: 'arg{'}";
          const callbacks = new MockCallbacks();
          const insert = buildInsertInfo({
            match: /^mock insert/,
          });
        ...
        it("should create a variable reference for a first arg that's an expression and contains a variable", () => {
          ...
          expect(result[1]).to.eql({
            contents: "tempy.prop",
            location: Location.create("fake-uri", Range.create(1, 29, 1, 33)),
            kind: OChapbookSymbolKind.Property,
          });
        });
        ...
        it("should create a passage reference for a first arg that's a passage", () => {
          ...
          expect(result).to.eql({
            contents: "arg",
            location: Location.create("fake-uri", Range.create(1, 24, 1, 27)),
            kind: TwineSymbolKind.Passage,
          });
        });
        ...
        it("should not create a passage reference for a link first arg that's a urlOrPassage", () => {
          const header = ":: Passage\n";
          const passage = "Insert: {mock insert:  'https://link.com'}";
          const callbacks = new MockCallbacks();
          const insert = buildInsertInfo({
            match: /^mock insert/,
          });
        ...
        it("should create a variable reference for a non-string first arg that's a urlOrPassage", () => {
          ...
          expect(result[1]).to.eql({
            contents: "arg.prop",
            location: Location.create("fake-uri", Range.create(1, 27, 1, 31)),
            kind: OChapbookSymbolKind.Property,
          });
        });
        ...
        it("should create a variable reference for a property that's a variable", () => {
          const header = ":: Passage\n";
          const passage = "Insert: {mock insert:  'arg', prop1: var1.prop }";
          const callbacks = new MockCallbacks();
          const insert = buildInsertInfo({
            match: /^mock insert/,
          });
          ...
          expect(result[0]).to.eql({
            contents: "var1",
            location: Location.create("fake-uri", Range.create(1, 37, 1, 41)),
            kind: OChapbookSymbolKind.Variable,
          });
          expect(result[1]).to.eql({
            contents: "var1.prop",
            location: Location.create("fake-uri", Range.create(1, 42, 1, 46)),
            kind: OChapbookSymbolKind.Property,
          });
        });
    ...
    describe("engine extensions", () => {
      it("should capture a symbol definition for a custom insert", () => {
        ...
        expect(result).to.eql({
          name: "hi\\s+there",
          contents: "hi\\s+there",
          location: Location.create("fake-uri", Range.create(4, 9, 4, 19)),
          kind: OChapbookSymbolKind.CustomInsert,
          match: /hi\s+there/,
        });
      });
      ...
      it("should capture symbol definitions for multiple custom inserts in a passage", () => {
        ...
        parser?.parsePassageText(passage, header.length, state);
        const [result0, result1] = callbacks.definitions as ChapbookSymbol[];
        ...
        expect(result1).to.eql({
          ...
          location: Location.create("fake-uri", Range.create(9, 9, 9, 27)),
          kind: OChapbookSymbolKind.CustomInsert,
          match: /different\s+insert/,
        });
      });
  ...
  describe("errors", () => {
    describe("vars section", () => {
      ...
      it("should error on spaces before a colon", () => {
        ...
        expect(result.message).to.include("Variable names can't have spaces");
      ...
      it("should error on an unclosed parenthesis before a colon", () => {
        ...
        expect(callbacks.errors.length).to.equal(1);
        expect(result.severity).to.eql(DiagnosticSeverity.Error);
        expect(result.message).to.include("Missing a close parenthesis");
    ...
    describe("text section", () => {
      ...
      describe("inserts", () => {
        ...
        it("should error on a function insert whose property has spaces", () => {
          ...
          expect(callbacks.errors.length).to.equal(1);
          expect(result.severity).to.eql(DiagnosticSeverity.Error);
          expect(result.message).to.include("Properties can't have spaces");
      ...
      describe("engine extensions", () => {
        ...
        it("should error on a custom insert with a non-regex match object", () => {
          ...
          expect(callbacks.errors.length).to.equal(1);
          expect(result.severity).to.eql(DiagnosticSeverity.Error);
          expect(result.message).to.include("Must be a regular expression");
