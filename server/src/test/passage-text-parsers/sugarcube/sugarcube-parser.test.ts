...
describe("SugarCube Parser", () => {
  describe("special passages", () => {
    it("should create an embedded css document for a stylesheet-tagged passage", () => {
      ...
      state.currentPassage.tags = [
        {
          contents: "stylesheet",
          location: Location.create("fake-uri", Range.create(0, 12, 0, 22)),
        },
      ];
      ...
      state.currentPassage.tags = [
        {
          ...
          location: Location.create("fake-uri", Range.create(0, 12, 0, 23)),
        },
      ];
      const parser = uut.getSugarCubeParser(undefined);
  ...
  describe("variables", () => {
      ...
      expect(result).to.eql([
        {
          ...
          location: Location.create("fake-uri", Range.create(2, 10, 2, 24)),
      ...
      expect(result).to.eql([
        {
          ...
          location: Location.create("fake-uri", Range.create(2, 10, 2, 23)),
          kind: OSugarCubeSymbolKind.Variable,
        },
        {
          contents: "$bareVariable.prop",
          location: Location.create("fake-uri", Range.create(2, 24, 2, 28)),
    ...
    it("should capture a variable reference for a bare variable and a variable used in bracket property access", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "_otherVar",
          location: Location.create("fake-uri", Range.create(2, 24, 2, 33)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
  ...
  describe("links", () => {
    it("should produce no semantic tokens for an empty [[]] link", () => {
      const header = ":: Passage\n";
      const passage = "We shall introduce: a link!\n" + "Here it is: [[]]\n";
      const callbacks = new MockCallbacks();
      const state = buildParsingState({
        content: header + passage,
        callbacks: callbacks,
      ...
      expect(result).to.eql([
        {
          ...
          location: Location.create("fake-uri", Range.create(2, 15, 2, 29)),
    ...
    it("should capture variable references for a [[link]] with TwineScript", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 25, 2, 31)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[display|target]] link", () => {
      ...
      expect(result).to.eql([
        {
          contents: "target passage",
          location: Location.create("fake-uri", Range.create(2, 35, 2, 49)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[display->target]] link", () => {
      ...
      expect(result).to.eql([
        {
          contents: "target passage",
          location: Location.create("fake-uri", Range.create(2, 36, 2, 50)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[target][setter]] link", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 32, 2, 38)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should not capture a passage reference for a [[target][setter]] link with a function", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 28, 2, 34)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[display|target][setter]] link", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 52, 2, 58)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should not capture a passage reference for a [[display|target][setter]] link with a function", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 48, 2, 54)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[display->target][setter]] link", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 53, 2, 59)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should not capture a passage reference for a [[display->target][setter]] link with a function", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 49, 2, 55)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture the passage reference for a [[target<-display][setter]] link", () => {
      ...
      expect(result).to.eql([
        ...
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 54, 2, 60)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should not capture a passage reference for a [[target<-display][setter]] link with a function", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 50, 2, 56)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
  ...
  describe("macros", () => {
    ...
    it("should capture a reference for a known macro", () => {
      ...
      expect(result).to.eql({
        contents: "testy",
        location: Location.create("fake-uri", Range.create(1, 9, 1, 14)),
    ...
    describe("built-in macros", () => {
      ...
      it("should capture a reference for the script macro", () => {
        ...
        expect(result).to.eql({
          contents: "script",
          location: Location.create("fake-uri", Range.create(1, 9, 1, 15)),
          kind: OSugarCubeSymbolKind.KnownMacro,
        });
      });
      ...
      it("should create variables for the contents of a TwineScript script macro", () => {
        ...
        expect(result).to.eql([
          ...
          {
            contents: "$items",
            location: Location.create("fake-uri", Range.create(2, 4, 2, 10)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "_hit",
            location: Location.create("fake-uri", Range.create(3, 2, 3, 6)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
    ...
    describe("unknown macro arguments", () => {
      ...
      it("should capture variable references for argument values of unknown macros", () => {
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "$var1",
            location: Location.create("fake-uri", Range.create(1, 14, 1, 19)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "_var2",
            location: Location.create("fake-uri", Range.create(1, 23, 1, 28)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 38, 1, 44)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "$var2",
            location: Location.create("fake-uri", Range.create(1, 47, 1, 52)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "_var3",
            location: Location.create("fake-uri", Range.create(1, 54, 1, 59)),
            kind: OSugarCubeSymbolKind.Variable,
          },
          {
            contents: "$var4",
            location: Location.create("fake-uri", Range.create(1, 69, 1, 74)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
      ...
      it("should not capture variable references for bare words that don't start with $ or _ for unknown macros", () => {
        ...
        expect(results).to.eql([
          {
            contents: "a",
            location: Location.create("fake-uri", Range.create(1, 12, 1, 13)),
      ...
      it("should capture passage references for argument values for unknown macros", () => {
        ...
        expect(results[1]).to.eql({
          ...
          location: Location.create("fake-uri", Range.create(1, 16, 1, 28)),
          kind: TwineSymbolKind.Passage,
        });
      });
    });
    ...
    describe("Custom macro argument parsing", () => {
      ...
      it("should continue parsing macro arguments if the macro's custom parse function returns false", () => {
        ...
        expect(callbacks.references).to.eql([
          ...
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 14, 1, 20)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
    ...
    describe("T3LT macro arguments", () => {
      it("should produce semantic tokens for base argument types", () => {
        ...
        const macro = buildMacroInfoWithArgs({
          name: "a",
          args: ["boolean &+ number &+ bareword &+ string &+ (bool | var)"],
        });
        const mockFunction = ImportMock.mockFunction(
          macrosModule,
          "allMacros",
      ...
      it("should capture variable references for var types", () => {
        ...
        const macro = buildMacroInfoWithArgs({
          name: "a",
          args: ["boolean &+ number &+ bareword &+ (string |+ var | bool)"],
        });
        const mockFunction = ImportMock.mockFunction(
          macrosModule,
          "allMacros",
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 33, 1, 39)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
      ...
      it("should capture variable references for backticks used in text type arguments", () => {
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 23, 1, 29)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
      ...
      it("should capture references for link values", () => {
        ...
        expect(results.slice(1)).to.eql([
          ...
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 44, 1, 50)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
      ...
      it("should capture passage references for passage values that are strings", () => {
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "Passage Name",
            location: Location.create("fake-uri", Range.create(1, 20, 1, 32)),
            kind: TwineSymbolKind.Passage,
          },
        ]);
      });
      ...
      it("should capture passage references for passage values that are bare words", () => {
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "Passage",
            location: Location.create("fake-uri", Range.create(1, 19, 1, 26)),
            kind: TwineSymbolKind.Passage,
          },
        ]);
      });
      ...
      it("should capture variable references for receiver values", () => {
        ...
        expect(results.slice(1)).to.eql([
          {
            contents: "$testy",
            location: Location.create("fake-uri", Range.create(1, 20, 1, 26)),
            kind: OSugarCubeSymbolKind.Variable,
          },
        ]);
      });
  ...
  describe("html and svg attributes", () => {
      ...
      expect(result).to.eql([
        {
          ...
          location: Location.create("fake-uri", Range.create(2, 39, 2, 51)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture a variable reference in an a tag's data-passage attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$tempy",
          location: Location.create("fake-uri", Range.create(2, 39, 2, 45)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture a passage reference in an area tag's data-passage attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "OtherPassage",
          location: Location.create("fake-uri", Range.create(2, 43, 2, 55)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture a passage reference in a button tag's data-passage attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "OtherPassage",
          location: Location.create("fake-uri", Range.create(2, 46, 2, 58)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture a passage reference in an img tag's data-passage attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "OtherPassage",
          location: Location.create("fake-uri", Range.create(2, 42, 2, 54)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture a passage reference in a source tag's data-passage attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "OtherPassage",
          location: Location.create("fake-uri", Range.create(2, 44, 2, 56)),
          kind: TwineSymbolKind.Passage,
        },
      ]);
    });
    ...
    it("should capture a variable reference in an a tag's data-setter attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$thing",
          location: Location.create("fake-uri", Range.create(2, 38, 2, 44)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture a variable reference in an area tag's data-setter attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$thing",
          location: Location.create("fake-uri", Range.create(2, 42, 2, 48)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture a variable reference in a button tag's data-setter attribute", () => {
      ...
      expect(result).to.eql([
        {
          contents: "$thing",
          location: Location.create("fake-uri", Range.create(2, 45, 2, 51)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture a variable reference in an sc-eval attribute directive", () => {
      ...
      expect(result).to.eql([
        {
          contents: "_id",
          location: Location.create("fake-uri", Range.create(2, 49, 2, 52)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
    ...
    it("should capture a variable reference in an @ attribute directive", () => {
      ...
      expect(result).to.eql([
        {
          contents: "_id",
          location: Location.create("fake-uri", Range.create(2, 42, 2, 45)),
          kind: OSugarCubeSymbolKind.Variable,
        },
      ]);
    });
  ...
  describe("html", () => {
    ...
    it("should create an embedded css document for the style tag", () => {
      ...
      expect(result.document.getText()).to.eql("p {\n  color: #26b72b;\n}");
      expect(result.document.languageId).to.eql("css");
  ...
  describe("errors", () => {
    describe("special passages", () => {
      ...
      it("should error on a passage with multiple media tags", () => {
        ...
        state.currentPassage.tags = [
          ...
          {
            contents: "Twine.audio",
            location: Location.create("fake-uri", Range.create(0, 25, 0, 31)),
          },
        ];
        state.storyFormat = {
          format: "SugarCube",
    ...
    describe("macros", () => {
      ...
      it("should error on a container macro that's missing its closing macro", () => {
        ...
        expect(callbacks.errors.length).to.equal(1);
        expect(result.severity).to.eql(DiagnosticSeverity.Error);
        expect(result.message).to.include("Closing macro <</testy>> not found");
        expect(result.range).to.eql(Range.create(1, 10, 1, 19));
      });
      ...
      it("should error on a container macro that's missing its opening macro", () => {
        ...
        expect(callbacks.errors.length).to.equal(1);
        expect(result.severity).to.eql(DiagnosticSeverity.Error);
        expect(result.message).to.include("Opening macro <<testy>> not found");
        expect(result.range).to.eql(Range.create(1, 10, 1, 20));
      });
      ...
      describe("macro arguments", () => {
        ...
        it("should raise an error for a non-boolean argument to a macro that takes a boolean", () => {
          ...
          expect(callbacks.errors.length).to.equal(1);
          expect(result.severity).to.eql(DiagnosticSeverity.Error);
          expect(result.message).to.include("Argument is not a boolean");
