...
describe("SugarCube TwineScript", () => {
  ...
  describe("is TwineScript", () => {
    ...
    it("should return true for a complex TwineScript expression", () => {
      ...
      const result = uut.isTwineScriptExpression('$var to (17 + 23) - "text"');
  ...
  describe("tokenize TwineScript", () => {
    ...
    it("should return apparent variables for variable assignment", () => {
      ...
      expect(result[0]).to.eql([
        {
          contents: "$varbl",
          location: Location.create("fake-uri", Range.create(1, 0, 1, 6)),
        },
      ]);
    ...
    it("should return apparent properties for variable assignment", () => {
      ...
      expect(result[1]).to.eql([
        {
          contents: "rootprop1",
          location: Location.create("fake-uri", Range.create(1, 7, 1, 16)),
          prefix: "$varbl",
        },
        {
          contents: "rootprop2",
          location: Location.create("fake-uri", Range.create(1, 17, 1, 26)),
