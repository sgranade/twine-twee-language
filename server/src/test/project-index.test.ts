...
describe("Project Index", () => {
  ...
  describe("References", () => {
    ...
    it("should return references for indexed files", () => {
      const references = [
        {
          contents: "one",
          locations: [Location.create("fake-uri", Range.create(1, 2, 3, 4))],
          kind: 1,
        },
        {
          contents: "two",
  ...
  describe("Folding Ranges", () => {
    ...
    it("should return ranges for indexed files", () => {
      const fakeRanges = [Range.create(1, 2, 3, 4), Range.create(5, 6, 7, 8)];
      const index = new uut.Index();
  ...
  describe("Definition At", () => {
    it("should return undefined for a position where no passage name is defined", () => {
      ...
      const result = index.getDefinitionAt("fake-uri", Position.create(2, 3));
    ...
    it("should return the passage for a position in its name", () => {
      ...
      const result = index.getDefinitionAt("fake-uri", Position.create(4, 4));
    ...
    it("should return a symbol definition for a position in that definition", () => {
      ...
      const result = index.getDefinitionAt("fake-uri", Position.create(6, 4));
  ...
  describe("References At", () => {
    it("should return references for a position in one of that references' locations", () => {
      ...
      const result = index.getReferencesAt("fake-uri", Position.create(10, 2));
  ...
  describe("Definition By Symbol At", () => {
    it("should return undefined for a position where no symbol or reference exists", () => {
      ...
      const passageReferences = [
        {
          contents: "Passage 1",
          locations: [Location.create("fake-uri", Range.create(5, 2, 5, 4))],
          kind: uut.TwineSymbolKind.Passage,
        },
        {
          contents: "Passage 2",
  ...
  describe("Removing Documents", () => {
    ...
    it("should remove definitions from a deleted document", () => {
      const definitions1 = [
        {
          contents: "one",
          location: Location.create("file1", Range.create(1, 2, 3, 4)),
          kind: 1,
        },
      ];
      const definitions2 = [
        {
          contents: "two",
          location: Location.create("file2", Range.create(5, 6, 7, 8)),
          kind: 1,
        },
      ];
      const index = new uut.Index();
    ...
    it("should remove references from a deleted document", () => {
      const references1 = [
        {
          contents: "one",
          locations: [Location.create("file1", Range.create(1, 2, 3, 4))],
          kind: 1,
        },
      ];
      const references2 = [
        {
          contents: "two",
          locations: [Location.create("file2", Range.create(5, 6, 7, 8))],
          kind: 1,
        },
      ];
      const index = new uut.Index();
