  ...
  describe("Symbols", () => {
    ...
    it("should generate class symbols for passages", () => {
      ...
      const passages = [
        buildPassage({
          label: "Passage 1",
          location: Location.create("test-uri", Range.create(0, 0, 0, 12)),
          scope: Range.create(0, 0, 7, 17),
        }),
        buildPassage({
          label: "Passage 2",
          location: Location.create("test-uri", Range.create(8, 0, 8, 9)),
    ...
    it("should skip class symbols for passages whose name is empty", () => {
      ...
      const passages = [
        buildPassage({
          label: "",
          location: Location.create("test-uri", Range.create(0, 0, 0, 3)),
