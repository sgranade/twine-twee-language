      ...
      index.setDefinitions("source-uri", [
        {
          ...
          location: Location.create("source-uri", Range.create(3, 4, 3, 7)),
        },
      ]);
      ...
      index.setReferences("source-uri", [
        {
          contents: "defined",
          kind: TwineSymbolKind.Passage,
          locations: [Location.create("source-uri", Range.create(3, 4, 3, 7))],
        },
      ]);
    ...
    describe("Passages", () => {
      it("should rename passages at the passage's actual location", () => {
        ...
        const passageReferences = [
          {
            contents: "Passage 1",
            locations: [Location.create("other-uri", Range.create(5, 2, 5, 4))],
            kind: TwineSymbolKind.Passage,
          },
          {
            contents: "Passage 2",
        ...
        expect(result).to.eql({
          changes: {
            "fake-uri": [
              TextEdit.replace(Range.create(1, 1, 2, 2), "New Passage 1"),
            ],
            "other-uri": [
              TextEdit.replace(Range.create(5, 2, 5, 4), "New Passage 1"),
            ],
          },
        });
      });
